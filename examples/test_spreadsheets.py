...
auth.update_token(config["ex_auth"], [config["spreadsheets_scope"]]) #First we create or update our token...

#We need an instance of GSpreadsheets():
sheets = GSpreadsheets(config["ex_token"], [config["spreadsheets_scope"]])
